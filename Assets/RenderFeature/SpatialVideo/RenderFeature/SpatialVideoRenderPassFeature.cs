...
public class SpatialVideoRenderPassFeature : ScriptableRendererFeature
{
    ...
    public class SpatialVideoRenderPass : ScriptableRenderPass
    {
        ...
        private RenderTextureDescriptor _sourceRTDescriptor;
        ...
        public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
        {
            ...
            _sourceRTDescriptor = sourceRTDescriptor;
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            // blur final pass RT
            cmd.GetTemporaryRT(_blurResultId, _sourceRTDescriptor);
            _blurResultRT = new RenderTargetIdentifier(_blurResultId);
            
            // blur pass 1 RT
            _sourceRTDescriptor.width /= 2;
            _sourceRTDescriptor.height /= 2;
            cmd.GetTemporaryRT(_blurResultId0, _sourceRTDescriptor);
            _blurResultRT0 = new RenderTargetIdentifier(_blurResultId0);
        ...
        private void BlurPass(CommandBuffer cmd)
        {
            ...
            // 4 pass 
            _sourceTextureSize /= 2;
            Draw(_blurResultId0, _owner.blurTexture, _sourceTextureSize, 
                _sourceTextureSize / 2, cmd);
        }
        ...
        private void Draw(int sourceId, RenderTexture targetId, Vector2 sourceSize, Vector2 targetSize, CommandBuffer buffer, bool isOrigin = false)
        {
            // horizon
            buffer.GetTemporaryRT(_blurVideoHorizonId, (int)targetSize.x, (int)targetSize.y,
                0, FilterMode.Bilinear, GraphicsFormat.R8G8B8A8_UNorm);
            // buffer.GetTemporaryRTArray(_blurVideoHorizonId, (int)targetSize.x, (int)targetSize.y, 0, 0, FilterMode.Bilinear, GraphicsFormat.R8G8B8A8_UNorm);
            buffer.SetRenderTarget(_blurVideoHorizonId);
            _owner.blurHorizon.SetVector(SourceTextureSize, new Vector4(sourceSize.x, sourceSize.y, 0f, 0f));
            if (isOrigin)
            {
